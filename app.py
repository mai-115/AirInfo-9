...
INDIAN_AIRLINE_CODES = {
    ...
    'S5',   # Star Air
    'S9',   # FlyBig
    'G8',   # Go First (historical, may appear in data)
}
...
def scrape():
    ...
    if airline not in INDIAN_AIRLINE_CODES:
        error = f'"{airline}" is not a supported Indian airline code. Use one of: {", ".join(sorted(INDIAN_AIRLINE_CODES))}.'
